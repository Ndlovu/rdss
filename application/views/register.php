    ...
    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            <div>
                ...
                <h1 class="logo-name">Identities</h1>

            </div>
            <h3>Register to system</h3>
            <p>Create account to see it in action.</p>
            <form class="m-t" method="post" role="form" action="<?php echo(base_url()); ?>index.php/register/create_user">
            ...
            <p class="m-t"> <small>Identities Tech. &copy; <?php echo(date("Y")); ?></small> </p>
        </div>
    </div>
